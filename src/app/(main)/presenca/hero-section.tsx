			...
			<div>
				...
				>
					...
					<p className="mt-4 text-justify hiddenOnPhone:px-2">
						...
						preencha todos os campos a baixo, informando a quantidade de familiares que irão lhe
						acompanhar, caso seja necessário, e não esqueça de colocar um e-mail válido para
						receber a sua confirmação de presença. Ficaremos muito felizes de recebê-lo em nossa
						cerimônia.
					</p>
				</motion.div>
			</div>
